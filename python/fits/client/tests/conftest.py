...
from fits.infra.v1.bmc_connect import (
    BMCServiceWSGIApplication,
)
from fits.infra.v1.component_connect import (
...
def test_client(
    ...
    services = {
        ...
        "/fits.infra.v1.BMCService": BMCServiceWSGIApplication(mock_bmc_service),
        "/fits.infra.v1.ComponentService": ComponentServiceWSGIApplication(
            mock_component_service
        ),
    }
