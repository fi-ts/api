...
func GetServices() []string {
	return []string{
		...
		"fits.api.vm.v1.LocationService",
		"fits.api.vm.v1.OSService",
		"fits.api.vm.v1.StageTypeService",
		"fits.api.vm.v1.VMService",
		"fits.api.vm.v1.VlanService",
	}
}
	...
	return &ServicePermissions{
		Roles: Roles{
			...
			Project: Project{
				v1.ProjectRole_PROJECT_ROLE_OWNER: map[string]struct{}{
					...
					"/fits.api.vm.v1.LocationService/List":         {},
					"/fits.api.vm.v1.OSService/List":               {},
					"/fits.api.vm.v1.StageTypeService/List":        {},
					"/fits.api.vm.v1.VMService/AddDisk":            {},
					"/fits.api.vm.v1.VMService/AddIP":              {},
					"/fits.api.vm.v1.VMService/Create":             {},
					"/fits.api.vm.v1.VMService/Delete":             {},
					"/fits.api.vm.v1.VMService/DeleteDisk":         {},
					"/fits.api.vm.v1.VMService/DeleteIP":           {},
					"/fits.api.vm.v1.VMService/Get":                {},
					"/fits.api.vm.v1.VMService/List":               {},
					"/fits.api.vm.v1.VMService/MoveIP":             {},
					"/fits.api.vm.v1.VMService/Update":             {},
					"/fits.api.vm.v1.VMService/UpdateDisk":         {},
					"/fits.api.vm.v1.VMService/ValidateAddDisk":    {},
					"/fits.api.vm.v1.VMService/ValidateAddIP":      {},
					"/fits.api.vm.v1.VMService/ValidateCreate":     {},
					"/fits.api.vm.v1.VMService/ValidateUpdateDisk": {},
					"/fits.api.vm.v1.VlanService/List":             {},
				},
		...
		Visibility: Visibility{
			...
			Project: map[string]bool{
				...
				"/fits.api.vm.v1.LocationService/List":         true,
				"/fits.api.vm.v1.OSService/List":               true,
				"/fits.api.vm.v1.StageTypeService/List":        true,
				"/fits.api.vm.v1.VMService/AddDisk":            true,
				"/fits.api.vm.v1.VMService/AddIP":              true,
				"/fits.api.vm.v1.VMService/Create":             true,
				"/fits.api.vm.v1.VMService/Delete":             true,
				"/fits.api.vm.v1.VMService/DeleteDisk":         true,
				"/fits.api.vm.v1.VMService/DeleteIP":           true,
				"/fits.api.vm.v1.VMService/Get":                true,
				"/fits.api.vm.v1.VMService/List":               true,
				"/fits.api.vm.v1.VMService/MoveIP":             true,
				"/fits.api.vm.v1.VMService/Update":             true,
				"/fits.api.vm.v1.VMService/UpdateDisk":         true,
				"/fits.api.vm.v1.VMService/ValidateAddDisk":    true,
				"/fits.api.vm.v1.VMService/ValidateAddIP":      true,
				"/fits.api.vm.v1.VMService/ValidateCreate":     true,
				"/fits.api.vm.v1.VMService/ValidateUpdateDisk": true,
				"/fits.api.vm.v1.VlanService/List":             true,
			},
		},
		Auditable: map[string]bool{
			...
			"/fits.api.vm.v1.LocationService/List":         false,
			"/fits.api.vm.v1.OSService/List":               false,
			"/fits.api.vm.v1.StageTypeService/List":        false,
			"/fits.api.vm.v1.VMService/AddDisk":            true,
			"/fits.api.vm.v1.VMService/AddIP":              true,
			"/fits.api.vm.v1.VMService/Create":             true,
			"/fits.api.vm.v1.VMService/Delete":             true,
			"/fits.api.vm.v1.VMService/DeleteDisk":         true,
			"/fits.api.vm.v1.VMService/DeleteIP":           true,
			"/fits.api.vm.v1.VMService/Get":                false,
			"/fits.api.vm.v1.VMService/List":               false,
			"/fits.api.vm.v1.VMService/MoveIP":             true,
			"/fits.api.vm.v1.VMService/Update":             true,
			"/fits.api.vm.v1.VMService/UpdateDisk":         true,
			"/fits.api.vm.v1.VMService/ValidateAddDisk":    false,
			"/fits.api.vm.v1.VMService/ValidateAddIP":      false,
			"/fits.api.vm.v1.VMService/ValidateCreate":     false,
			"/fits.api.vm.v1.VMService/ValidateUpdateDisk": false,
			"/fits.api.vm.v1.VlanService/List":             false,
		},
	}
}
