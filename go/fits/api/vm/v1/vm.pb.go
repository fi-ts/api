...
type VMInstance struct {
	...
	Contract bool `protobuf:"varint,12,opt,name=contract,proto3" json:"contract,omitempty"`
	...
	Serviceclass string `protobuf:"bytes,15,opt,name=serviceclass,proto3" json:"serviceclass,omitempty"`
	// Status of the ongoing operation.
	Status string `protobuf:"bytes,16,opt,name=status,proto3" json:"status,omitempty"`
	// Additional information about the current status.
	StatusInfo string `protobuf:"bytes,17,opt,name=status_info,json=statusInfo,proto3" json:"status_info,omitempty"`
	...
	Interfaces []*NetworkInterface `protobuf:"bytes,20,rep,name=interfaces,proto3" json:"interfaces,omitempty"`
	// VLAN the VM is attached to.
	Vlan          *Vlan `protobuf:"bytes,21,opt,name=vlan,proto3" json:"vlan,omitempty"`
...
type VMInstance_WindowsDetails struct {
	...
	WindowsDetails *WindowsDetails `protobuf:"bytes,18,opt,name=windows_details,json=windowsDetails,proto3,oneof"`
}

type VMInstance_LinuxDetails struct {
	// Linux-specific settings (LDAP + disks).
	LinuxDetails *LinuxDetails `protobuf:"bytes,19,opt,name=linux_details,json=linuxDetails,proto3,oneof"`
}
