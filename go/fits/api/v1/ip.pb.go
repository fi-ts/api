...
func (IPType) Descriptor() protoreflect.EnumDescriptor {
	return file_fits_api_v1_ip_proto_enumTypes[0].Descriptor()
}

func (IPType) Type() protoreflect.EnumType {
	return &file_fits_api_v1_ip_proto_enumTypes[0]
}
...
func (IPType) EnumDescriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{0}
}
...
func (IPAddressFamily) Descriptor() protoreflect.EnumDescriptor {
	return file_fits_api_v1_ip_proto_enumTypes[1].Descriptor()
}

func (IPAddressFamily) Type() protoreflect.EnumType {
	return &file_fits_api_v1_ip_proto_enumTypes[1]
}
...
func (IPAddressFamily) EnumDescriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{1}
}
...
type IP struct {
	...
	// Type of this ip
	Type IPType `protobuf:"varint,8,opt,name=type,proto3,enum=fits.api.v1.IPType" json:"type,omitempty"`
...
func (x *IP) Reset() {
	*x = IP{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[0]
...
func (x *IPServiceGetRequest) Reset() {
	*x = IPServiceGetRequest{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type IPServiceCreateRequest struct {
	...
	Type *IPType `protobuf:"varint,8,opt,name=type,proto3,enum=fits.api.v1.IPType,oneof" json:"type,omitempty"`
	// Addressfamily of the IP to create, defaults to ipv4
	AddressFamily *IPAddressFamily `protobuf:"varint,9,opt,name=address_family,json=addressFamily,proto3,enum=fits.api.v1.IPAddressFamily,oneof" json:"address_family,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IPServiceCreateRequest) Reset() {
	*x = IPServiceCreateRequest{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceCreateRequest) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{2}
}
...
type IPServiceUpdateRequest struct {
	...
	// Type of this ip
	Type *IPType `protobuf:"varint,6,opt,name=type,proto3,enum=fits.api.v1.IPType,oneof" json:"type,omitempty"`
	// Labels on this ip
...
func (x *IPServiceUpdateRequest) Reset() {
	*x = IPServiceUpdateRequest{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceUpdateRequest) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{3}
}
...
func (x *IPServiceListRequest) Reset() {
	*x = IPServiceListRequest{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceListRequest) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{4}
}
...
type IPQuery struct {
	...
	Type *IPType `protobuf:"varint,9,opt,name=type,proto3,enum=fits.api.v1.IPType,oneof" json:"type,omitempty"`
	// Addressfamily of the IPs to list, defaults to all addressfamilies
	AddressFamily *IPAddressFamily `protobuf:"varint,10,opt,name=address_family,json=addressFamily,proto3,enum=fits.api.v1.IPAddressFamily,oneof" json:"address_family,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IPQuery) Reset() {
	*x = IPQuery{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPQuery) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{5}
}
...
func (x *IPServiceDeleteRequest) Reset() {
	*x = IPServiceDeleteRequest{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceDeleteRequest) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{6}
}
...
func (x *IPServiceGetResponse) Reset() {
	*x = IPServiceGetResponse{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceGetResponse) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{7}
}
...
func (x *IPServiceUpdateResponse) Reset() {
	*x = IPServiceUpdateResponse{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceUpdateResponse) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{8}
}
...
func (x *IPServiceCreateResponse) Reset() {
	*x = IPServiceCreateResponse{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceCreateResponse) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{9}
}
...
func (x *IPServiceListResponse) Reset() {
	*x = IPServiceListResponse{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceListResponse) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{10}
}
...
func (x *IPServiceDeleteResponse) Reset() {
	*x = IPServiceDeleteResponse{}
	mi := &file_fits_api_v1_ip_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IPServiceDeleteResponse) Descriptor() ([]byte, []int) {
	return file_fits_api_v1_ip_proto_rawDescGZIP(), []int{11}
}
...
var File_fits_api_v1_ip_proto protoreflect.FileDescriptor

const file_fits_api_v1_ip_proto_rawDesc = "" +
	"\n" +
	"\x14fits/api/v1/ip.proto\x12\vfits.api.v1\x1a\x1bbuf/validate/validate.proto\x1a\x18fits/api/v1/common.proto\x1a\"fits/api/v1/predefined_rules.proto\"\xeb\x02\n" +
	"\x02IP\x12\x1c\n" +
	"\x04uuid\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x04uuid\x12%\n" +
	"\x04meta\x18\x02 \x01(\v2\x11.fits.api.v1.MetaR\x04meta\x12\x17\n" +
	...
	"\aproject\x18\a \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\aproject\x121\n" +
	"\x04type\x18\b \x01(\x0e2\x13.fits.api.v1.IPTypeB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04type\x12+\n" +
	...
	"\amachine\x18\x06 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01H\x03R\amachine\x88\x01\x01\x120\n" +
	"\x06labels\x18\a \x01(\v2\x13.fits.api.v1.LabelsH\x04R\x06labels\x88\x01\x01\x126\n" +
	"\x04type\x18\b \x01(\x0e2\x13.fits.api.v1.IPTypeB\b\xbaH\x05\x82\x01\x02\x10\x01H\x05R\x04type\x88\x01\x01\x12R\n" +
	"\x0eaddress_family\x18\t \x01(\x0e2\x1c.fits.api.v1.IPAddressFamilyB\b\xbaH\x05\x82\x01\x02\x10\x01H\x06R\raddressFamily\x88\x01\x01B\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_descriptionB\x05\n" +
	"\x03_ipB\n" +
	"\n" +
	...
	"\vdescription\x18\x05 \x01(\tB\v\xbaH\br\x06ȳ\xae\xb1\x02\x01H\x01R\vdescription\x88\x01\x01\x126\n" +
	"\x04type\x18\x06 \x01(\x0e2\x13.fits.api.v1.IPTypeB\b\xbaH\x05\x82\x01\x02\x10\x01H\x02R\x04type\x88\x01\x01\x126\n" +
	"\x06labels\x18\a \x01(\v2\x19.fits.api.v1.UpdateLabelsH\x03R\x06labels\x88\x01\x01B\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_descriptionB\a\n" +
	"\x05_typeB\t\n" +
	"\a_labels\"f\n" +
	...
	"\x05query\x18\x02 \x01(\v2\x14.fits.api.v1.IPQueryR\x05query\"\xe4\x04\n" +
	"\aIPQuery\x12\x1c\n" +
	...
	"\x12parent_prefix_cidr\x18\a \x01(\tB\b\xbaH\x05r\x03\xe8\x01\x01H\x06R\x10parentPrefixCidr\x88\x01\x01\x120\n" +
	"\x06labels\x18\b \x01(\v2\x13.fits.api.v1.LabelsH\aR\x06labels\x88\x01\x01\x126\n" +
	"\x04type\x18\t \x01(\x0e2\x13.fits.api.v1.IPTypeB\b\xbaH\x05\x82\x01\x02\x10\x01H\bR\x04type\x88\x01\x01\x12R\n" +
	"\x0eaddress_family\x18\n" +
	" \x01(\x0e2\x1c.fits.api.v1.IPAddressFamilyB\b\xbaH\x05\x82\x01\x02\x10\x01H\tR\raddressFamily\x88\x01\x01B\x05\n" +
	"\x03_ipB\n" +
	"\n" +
	"\b_networkB\n" +
	"\n" +
	...
	"\x02ip\x18\x01 \x01(\tB\a\xbaH\x04r\x02p\x01R\x02ip\x12\"\n" +
	"\aproject\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\aproject\"7\n" +
	"\x14IPServiceGetResponse\x12\x1f\n" +
	"\x02ip\x18\x01 \x01(\v2\x0f.fits.api.v1.IPR\x02ip\":\n" +
	"\x17IPServiceUpdateResponse\x12\x1f\n" +
	"\x02ip\x18\x01 \x01(\v2\x0f.fits.api.v1.IPR\x02ip\":\n" +
	"\x17IPServiceCreateResponse\x12\x1f\n" +
	"\x02ip\x18\x01 \x01(\v2\x0f.fits.api.v1.IPR\x02ip\":\n" +
	"\x15IPServiceListResponse\x12!\n" +
	"\x03ips\x18\x01 \x03(\v2\x0f.fits.api.v1.IPR\x03ips\":\n" +
	"\x17IPServiceDeleteResponse\x12\x1f\n" +
	"\x02ip\x18\x01 \x01(\v2\x0f.fits.api.v1.IPR\x02ip*g\n" +
	"\x06IPType\x12\x17\n" +
	...
	"\x14IP_ADDRESS_FAMILY_V6\x10\x02\x1a\b\x82\xb2\x19\x04ipv62\xe3\x03\n" +
	"\tIPService\x12W\n" +
	"\x03Get\x12 .fits.api.v1.IPServiceGetRequest\x1a!.fits.api.v1.IPServiceGetResponse\"\v\xca\xf3\x18\x03\x01\x02\x03\xe0\xf3\x18\x02\x12_\n" +
	"\x06Create\x12#.fits.api.v1.IPServiceCreateRequest\x1a$.fits.api.v1.IPServiceCreateResponse\"\n" +
	...
	"\x04List\x12!.fits.api.v1.IPServiceListRequest\x1a\".fits.api.v1.IPServiceListResponse\"\v\xca\xf3\x18\x03\x01\x02\x03\xe0\xf3\x18\x02\x12_\n" +
	"\x06Delete\x12#.fits.api.v1.IPServiceDeleteRequest\x1a$.fits.api.v1.IPServiceDeleteResponse\"\n" +
	"\xca\xf3\x18\x02\x01\x02\xe0\xf3\x18\x01B\x93\x01\n" +
	"\x0fcom.fits.api.v1B\aIpProtoP\x01Z)github.com/fi-ts/api/go/fits/api/v1;apiv1\xa2\x02\x03FAX\xaa\x02\vFits.Api.V1\xca\x02\vFits\\Api\\V1\xe2\x02\x17Fits\\Api\\V1\\GPBMetadata\xea\x02\rFits::Api::V1b\x06proto3"

var (
	file_fits_api_v1_ip_proto_rawDescOnce sync.Once
	file_fits_api_v1_ip_proto_rawDescData []byte
)

func file_fits_api_v1_ip_proto_rawDescGZIP() []byte {
	file_fits_api_v1_ip_proto_rawDescOnce.Do(func() {
		file_fits_api_v1_ip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_fits_api_v1_ip_proto_rawDesc), len(file_fits_api_v1_ip_proto_rawDesc)))
	})
	return file_fits_api_v1_ip_proto_rawDescData
}

var file_fits_api_v1_ip_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_fits_api_v1_ip_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_fits_api_v1_ip_proto_goTypes = []any{
	(IPType)(0),                     // 0: fits.api.v1.IPType
	(IPAddressFamily)(0),            // 1: fits.api.v1.IPAddressFamily
	(*IP)(nil),                      // 2: fits.api.v1.IP
	(*IPServiceGetRequest)(nil),     // 3: fits.api.v1.IPServiceGetRequest
	(*IPServiceCreateRequest)(nil),  // 4: fits.api.v1.IPServiceCreateRequest
	(*IPServiceUpdateRequest)(nil),  // 5: fits.api.v1.IPServiceUpdateRequest
	(*IPServiceListRequest)(nil),    // 6: fits.api.v1.IPServiceListRequest
	(*IPQuery)(nil),                 // 7: fits.api.v1.IPQuery
	(*IPServiceDeleteRequest)(nil),  // 8: fits.api.v1.IPServiceDeleteRequest
	(*IPServiceGetResponse)(nil),    // 9: fits.api.v1.IPServiceGetResponse
	(*IPServiceUpdateResponse)(nil), // 10: fits.api.v1.IPServiceUpdateResponse
	(*IPServiceCreateResponse)(nil), // 11: fits.api.v1.IPServiceCreateResponse
	(*IPServiceListResponse)(nil),   // 12: fits.api.v1.IPServiceListResponse
	(*IPServiceDeleteResponse)(nil), // 13: fits.api.v1.IPServiceDeleteResponse
	(*Meta)(nil),                    // 14: fits.api.v1.Meta
	(*Labels)(nil),                  // 15: fits.api.v1.Labels
	(*UpdateMeta)(nil),              // 16: fits.api.v1.UpdateMeta
	(*UpdateLabels)(nil),            // 17: fits.api.v1.UpdateLabels
}
var file_fits_api_v1_ip_proto_depIdxs = []int32{
	14, // 0: fits.api.v1.IP.meta:type_name -> fits.api.v1.Meta
	0,  // 1: fits.api.v1.IP.type:type_name -> fits.api.v1.IPType
	15, // 2: fits.api.v1.IPServiceCreateRequest.labels:type_name -> fits.api.v1.Labels
	0,  // 3: fits.api.v1.IPServiceCreateRequest.type:type_name -> fits.api.v1.IPType
	1,  // 4: fits.api.v1.IPServiceCreateRequest.address_family:type_name -> fits.api.v1.IPAddressFamily
	16, // 5: fits.api.v1.IPServiceUpdateRequest.update_meta:type_name -> fits.api.v1.UpdateMeta
	0,  // 6: fits.api.v1.IPServiceUpdateRequest.type:type_name -> fits.api.v1.IPType
	17, // 7: fits.api.v1.IPServiceUpdateRequest.labels:type_name -> fits.api.v1.UpdateLabels
	7,  // 8: fits.api.v1.IPServiceListRequest.query:type_name -> fits.api.v1.IPQuery
	15, // 9: fits.api.v1.IPQuery.labels:type_name -> fits.api.v1.Labels
	0,  // 10: fits.api.v1.IPQuery.type:type_name -> fits.api.v1.IPType
	1,  // 11: fits.api.v1.IPQuery.address_family:type_name -> fits.api.v1.IPAddressFamily
	2,  // 12: fits.api.v1.IPServiceGetResponse.ip:type_name -> fits.api.v1.IP
	2,  // 13: fits.api.v1.IPServiceUpdateResponse.ip:type_name -> fits.api.v1.IP
	2,  // 14: fits.api.v1.IPServiceCreateResponse.ip:type_name -> fits.api.v1.IP
	2,  // 15: fits.api.v1.IPServiceListResponse.ips:type_name -> fits.api.v1.IP
	2,  // 16: fits.api.v1.IPServiceDeleteResponse.ip:type_name -> fits.api.v1.IP
	3,  // 17: fits.api.v1.IPService.Get:input_type -> fits.api.v1.IPServiceGetRequest
	4,  // 18: fits.api.v1.IPService.Create:input_type -> fits.api.v1.IPServiceCreateRequest
	5,  // 19: fits.api.v1.IPService.Update:input_type -> fits.api.v1.IPServiceUpdateRequest
	6,  // 20: fits.api.v1.IPService.List:input_type -> fits.api.v1.IPServiceListRequest
	8,  // 21: fits.api.v1.IPService.Delete:input_type -> fits.api.v1.IPServiceDeleteRequest
	9,  // 22: fits.api.v1.IPService.Get:output_type -> fits.api.v1.IPServiceGetResponse
	11, // 23: fits.api.v1.IPService.Create:output_type -> fits.api.v1.IPServiceCreateResponse
	10, // 24: fits.api.v1.IPService.Update:output_type -> fits.api.v1.IPServiceUpdateResponse
	12, // 25: fits.api.v1.IPService.List:output_type -> fits.api.v1.IPServiceListResponse
	13, // 26: fits.api.v1.IPService.Delete:output_type -> fits.api.v1.IPServiceDeleteResponse
...
func init() { file_fits_api_v1_ip_proto_init() }
func file_fits_api_v1_ip_proto_init() {
	if File_fits_api_v1_ip_proto != nil {
		return
	}
	file_fits_api_v1_common_proto_init()
	file_fits_api_v1_predefined_rules_proto_init()
	file_fits_api_v1_ip_proto_msgTypes[0].OneofWrappers = []any{}
	file_fits_api_v1_ip_proto_msgTypes[1].OneofWrappers = []any{}
	file_fits_api_v1_ip_proto_msgTypes[2].OneofWrappers = []any{}
	file_fits_api_v1_ip_proto_msgTypes[3].OneofWrappers = []any{}
	file_fits_api_v1_ip_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_fits_api_v1_ip_proto_rawDesc), len(file_fits_api_v1_ip_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_fits_api_v1_ip_proto_goTypes,
		DependencyIndexes: file_fits_api_v1_ip_proto_depIdxs,
		EnumInfos:         file_fits_api_v1_ip_proto_enumTypes,
		MessageInfos:      file_fits_api_v1_ip_proto_msgTypes,
	}.Build()
	File_fits_api_v1_ip_proto = out.File
	file_fits_api_v1_ip_proto_goTypes = nil
	file_fits_api_v1_ip_proto_depIdxs = nil
}
