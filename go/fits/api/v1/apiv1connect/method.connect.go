...
const (
	...
	MethodServiceName = "fits.api.v1.MethodService"
)
...
const (
	...
	MethodServiceListProcedure = "/fits.api.v1.MethodService/List"
	// MethodServiceTokenScopedListProcedure is the fully-qualified name of the MethodService's
	// TokenScopedList RPC.
	MethodServiceTokenScopedListProcedure = "/fits.api.v1.MethodService/TokenScopedList"
)

// MethodServiceClient is a client for the fits.api.v1.MethodService service.
type MethodServiceClient interface {
	// Returns the list of all public visible methods.
	List(context.Context, *v1.MethodServiceListRequest) (*v1.MethodServiceListResponse, error)
	// TokenScopedList returns all methods callable with the token present in the request.
	TokenScopedList(context.Context, *v1.MethodServiceTokenScopedListRequest) (*v1.MethodServiceTokenScopedListResponse, error)
}

// NewMethodServiceClient constructs a client for the fits.api.v1.MethodService service. By default,
...
func NewMethodServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MethodServiceClient {
	...
	methodServiceMethods := v1.File_fits_api_v1_method_proto.Services().ByName("MethodService").Methods()
...
// List calls fits.api.v1.MethodService.List.
func (c *methodServiceClient) List(ctx context.Context, req *v1.MethodServiceListRequest) (*v1.MethodServiceListResponse, error) {
...
// TokenScopedList calls fits.api.v1.MethodService.TokenScopedList.
func (c *methodServiceClient) TokenScopedList(ctx context.Context, req *v1.MethodServiceTokenScopedListRequest) (*v1.MethodServiceTokenScopedListResponse, error) {
...
// MethodServiceHandler is an implementation of the fits.api.v1.MethodService service.
...
func NewMethodServiceHandler(svc MethodServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/fits.api.v1.MethodService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMethodServiceHandler) List(context.Context, *v1.MethodServiceListRequest) (*v1.MethodServiceListResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fits.api.v1.MethodService.List is not implemented"))
}

func (UnimplementedMethodServiceHandler) TokenScopedList(context.Context, *v1.MethodServiceTokenScopedListRequest) (*v1.MethodServiceTokenScopedListResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("fits.api.v1.MethodService.TokenScopedList is not implemented"))
}
